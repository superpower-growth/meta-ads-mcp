...
const CreateAdCreativeSchema = z.object({
  ...
  instagramActorId: z.string().optional().describe('Instagram actor ID for Instagram placements'),
...
export const createAdCreativeTool: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      instagramActorId: { type: 'string' as const, description: 'Instagram actor ID' },
